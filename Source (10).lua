	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 16, 28)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(16, 24, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 16, 28))
			}),
			["Color Hub 2"] = Color3.fromRGB(16, 24, 40),
			["Color Stroke"] = Color3.fromRGB(28, 45, 68),
			["Color Theme"] = Color3.fromRGB(80, 185, 255),
			["Color Text"] = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(135, 150, 170)
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
...
AddEle("Stroke", function(parent, props, ...)
	...
	local New = InsertTheme(SetProps(Create("UIStroke", parent, {
		Color = args[1] or Theme["Color Theme"],
...
function redzlib:MakeWindow(Configs)
    ...
    local StatusDot = Create("Frame", TopBar, {
        Size = UDim2.new(0, 8, 0, 8),
        AnchorPoint = Vector2.new(0, 0.5),
        Position = UDim2.new(0, 10, 0.5, 0),
        BackgroundColor3 = Theme["Color StatusDot"],
        BorderSizePixel = 0
    })Make("Corner", statusDot, UDim.new(1, 0))

    task.spawn(function()
        while task.wait(1.5) do
            TweenService:Create(statusDot, TweenInfo.new(0.6, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, 0, true), {
